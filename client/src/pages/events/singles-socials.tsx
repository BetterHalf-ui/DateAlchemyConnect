        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {faqKeys.map((faqKey, index) => (
              <Card key={index}>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">{t(`singles.faq.${faqKey}.question`)}</h3>
                  <p className="text-gray-600 leading-relaxed">{t(`singles.faq.${faqKey}.answer`)}</p>
                </CardContent>
              </Card>
            ))}
          </div>
