...
export const translations = {
  ...
  fr: {
    ...
    'home.comparison.userMindset.datingApps': 'Pas sérieux : Près de 50% veulent "quelque chose de décontracté"',
    ...
    'home.comparison.persistentContact.datingApps': '30% ont continué à contacter après refus',
