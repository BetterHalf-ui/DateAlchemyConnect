...
export const translations = {
  ...
  fr: {
    ...
    'home.membership.feature1': '**Présentations ultra-sélectionnées** avec des célibataires soigneusement choisis, rencontrés et vérifiés, correspondant à vos standards et prêts pour une relation authentique.',
    'home.membership.feature2': '**Évaluation approfondie de la compatibilité** basée sur vos exigences, valeurs, style de vie, objectifs et besoins relationnels (The Date Alchemy Needs Compatibility Score™). Nous utilisons également la théorie de l\'attachement pour éviter les incompatibilités toxiques dès le départ.',
    'home.membership.feature3': '**Mise en relation centrée sur l\'humain** : Nous utilisons l\'IA pour analyser la compatibilité, mais l\'intuition humaine prend la décision finale. Chaque introduction est soigneusement sélectionnée par de vraies personnes qui comprennent ce que vous recherchez.',
    'home.membership.feature4': '**Profils détaillés** : Vous recevez un profil complet incluant carrière, centres d\'intérêt, objectifs à long terme et ce qu\'ils recherchent chez un partenaire. Les photos sont partagées avec consentement mutuel.',
    'home.membership.feature5': '**Rendez-vous organisés pour vous** : nous réservons, confirmons et préparons le rendez-vous selon vos préférences - vous n\'avez qu\'à vous présenter sous votre meilleur jour.',
    'home.membership.feature6': '**Suivi post-rencontre** pris en charge pour vous — pas de ghosting, pas de relances maladroites.',
