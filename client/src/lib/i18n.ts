...
export const translations = {
  en: {
    ...
    'home.pricing.priceIncreaseDisclaimer': '*An initial Rs 800 payment covers the start of your personalized search, consultation, and insights. The remaining balance is payable only after your first successful match.',
  ...
  fr: {
    ...
    'home.pricing.priceIncreaseDisclaimer': '*Un paiement initial de Rs 800 couvre le début de votre recherche personnalisée, la consultation et les analyses. Le solde restant n\'est payable qu\'après votre premier match réussi.',
