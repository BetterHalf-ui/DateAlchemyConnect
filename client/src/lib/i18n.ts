...
export const translations = {
  ...
  fr: {
    ...
    'home.howItWorks.step3Title': 'Curated Introduction',
    ...
    'home.howItWorks.step4Title': 'Refinement & Follow-up',
