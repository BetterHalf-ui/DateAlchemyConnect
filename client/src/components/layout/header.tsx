...
export default function Header() {
  ...
  const needsWhiteHeader = location.startsWith('/blog') || location.startsWith('/admin') || location.startsWith('/network') || location.startsWith('/privacy-policy') || location.startsWith('/how-it-works') || location.startsWith('/events') || location.startsWith('/dating-patterns-guide') || location.startsWith('/apply');
