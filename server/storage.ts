...
export class MemStorage implements IStorage {
  ...
  private async initializeDefaultData() {
    ...
    // Create sample blog posts (reordered so "Chasing vs. Pursuing" is last/most recent)
    ...
    const postDates = [
      new Date('2025-06-05'), // "The Materialists" - oldest
      new Date('2025-06-12'), // "36 questions" - 6 weeks before
      new Date('2025-06-19'), // "New cool cafés" - 5 weeks before
      new Date('2025-06-26'), // "Is fighting a red flag?" - 4 weeks before
      new Date('2025-07-03'), // "How to spot a cheater?" - 3 weeks before
      new Date('2025-07-10'), // "Chasing vs. Pursuing" - 2 weeks before
    ];
